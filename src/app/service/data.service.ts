export const POSTS = [
  ...
  },
  {
    ...
    date: "18.05.2023",
    description: "Jak wskazuje nazwa karty, na jej pokładzie znalazło się 8 GB pamięci VRAM typu GDDR6 128-bit (18 Gbps). Dodatkowo, specyfikację uzupełniają rdzenie Ray Tracing 3. generacji oraz rdzenie Tensor 4. generacji. Warto również wspomnieć, że karta obsługuje popularną technikę upscalingu obrazu DLSS 3.0.",
